 ...
 */(private val listdata: List<CourseDataModel>,
     ...
     */
    var courseItemClick: CourseItemClick) : RecyclerView.Adapter<MyCourseListAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val layoutInflater = LayoutInflater.from(parent.context)
        val listItem = layoutInflater.inflate(R.layout.mycourses_list_item, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.price.text = myListData.price
        holder.rating.rating = myListData.ratings
